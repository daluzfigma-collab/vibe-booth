...
export default function Hero() {
    ...
    // TỐI ƯU: Chuyển sang tween để mượt hơn
    const itemVariants = {
    ...
    return (
        <section className="relative flex items-center min-h-screen pt-32 pb-20 overflow-hidden md:pt-48 md:pb-32">
            {/* TỐI ƯU: Giảm blur ở mobile */}
            <div className="absolute rounded-full top-1/4 left-1/4 w-96 h-96 bg-teal-300/30 mix-blend-multiply filter blur-2xl md:blur-3xl opacity-70 animate-blob"></div>
            <div className="absolute rounded-full top-1/3 right-1/4 w-96 h-96 bg-pink-300/30 mix-blend-multiply filter blur-2xl md:blur-3xl opacity-70 animate-blob animation-delay-2000"></div>
            ...
            <div className="container relative z-10 px-4 mx-auto md:px-6">
                <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-8">
                    ...
                    <motion.div
                        ...
                        animate="visible"
                    >
                        <motion.div variants={itemVariants} style={{ willChange: "transform, opacity" }} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/50 backdrop-blur-sm border border-slate-200/50 w-fit text-sm font-medium text-slate-700 shadow-sm">
                            <Sparkles className="w-4 h-4 text-teal-500" />
                            <span>{t('hero.badge', 'Giải pháp Photobooth B2B Toàn Diện')}</span>
                        </motion.div>

                        <motion.h1 variants={itemVariants} style={{ willChange: "transform, opacity" }} className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 leading-[1.15] tracking-tight">
                        ...
                        <motion.p variants={itemVariants} style={{ willChange: "transform, opacity" }} className="max-w-xl text-lg leading-relaxed md:text-xl text-slate-600">
                        ...
                        <motion.p variants={itemVariants} style={{ willChange: "transform, opacity" }} className="max-w-xl py-1 pl-4 text-base italic border-l-4 border-teal-400 md:text-lg text-slate-500">
                        ...
                        <motion.div variants={itemVariants} style={{ willChange: "transform, opacity" }} className="flex flex-col gap-4 mt-4 sm:flex-row">
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.6, type: "tween", ease: "easeOut", delay: 0.4 }} // Đổi sang tween
