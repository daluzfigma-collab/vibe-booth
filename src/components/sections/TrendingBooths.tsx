...
// Data models omitted for brevity, keep your original boothModels array
const boothModels = [
    { id: 1, img: '/booths/booth-6.jpg' },
    { id: 2, img: '/booths/booth-7.jpg' },
    { id: 3, img: '/booths/booth-8.jpg' },
    { id: 4, img: '/booths/booth-9.jpg' },
    { id: 5, img: '/booths/booth-10.jpg' },
    { id: 6, img: '/booths/booth-11.jpg' }
];
...
const containerVariants = {
    ...
    show: {
        opacity: 1,
        transition: { staggerChildren: 0.1 } // Giảm thời gian chờ
    }
};
...
const itemVariants = {
    ...
    show: { 
        ...
        y: 0, 
        transition: { 
            type: "tween", // TỐI ƯU: Đổi sang tween
            ease: "easeOut",
            duration: 0.4
        } 
    }
...
export default function TrendingBooths() {
    ...
    return (
        <section className="relative py-24 overflow-hidden bg-slate-50/50">
            {/* TỐI ƯU: Giảm blur trên mobile */}
            <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] rounded-full bg-teal-200/20 blur-[60px] md:blur-[100px]"></div>
                <div className="absolute bottom-[-10%] left-[-5%] w-[600px] h-[600px] rounded-full bg-rose-200/20 blur-[80px] md:blur-[120px]"></div>
            </div>
